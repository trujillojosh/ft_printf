...
static int hash_help(char *todo, int i)
{
	if ((i == 0) && (ft_tolower(todo[ft_strlen(todo) - 1]) == 'o'))
	{
		if (todo[ft_strlen(todo) - 2] == '.')
			return (1);
		else if ((todo[ft_strlen(todo) - 2] == '0') && (todo[ft_strlen(todo) - 3] == '.'))
			return (1);
		else
			return (0);
	}
...
int		ft_hash(char *str, char *todo, int start)
{
	...
	if (ft_char_count(todo, '#') > 0)
	{
		...
		// if ((i == 0) && (ft_tolower(todo[ft_strlen(todo) - 1]) == 'o'))
		// {
		// 	if ((todo[ft_strlen(todo) - 2] == '.') || ((todo[ft_strlen(todo) - 2] == '0') && (todo[ft_strlen(todo) - 3] == '.')))
		// 		return (0);
		// }
		// if ((todo[ft_strlen(todo) - 1] == 'o') && (str[0] == '0') && ((todo[ft_strlen(todo) - 2] == '.') || (todo[ft_strlen(todo) - 2] == '0')))
		// 	return (0);
